    ...
    return (
        <div className="signin">
            <form onSubmit={handleSignin} className="signin__form" >
                ...
                <input type="email" id="email-input" className="signin__input" placeholder="Email"
                    value={email} onChange={e => setEmail(e.target.value)} />
                <label htmlFor="password"></label>
                <input type="password" id="password-input" className="signin__input" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} />
