class Api {
  ...
  getCardList() {
    return Promise.resolve([
      {
        cardImage: require("../images/image_08.jpg"),
      ...
      {
        cardImage: require("../images/image_04.jpg"),
      ...
      {
        cardImage: require("../images/image_07.jpg"),
        ...
        website: "National Parks Traveler",
      },
      {
        cardImage: require("../images/image_05.jpg"),
        date: "October 19, 2020",
      ...
      {
        cardImage: require("../images/image_01.jpg"),
        date: "March 16, 2020",
